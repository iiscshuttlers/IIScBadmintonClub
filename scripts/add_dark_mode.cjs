...
function addDarkMode(filePath) {
  ...
  if (filePath.includes("LiveTournament.tsx")) {
    content = content.replace(
      /bg-gradient-to-br from-slate-50 to-emerald-50/g,
      "bg-gradient-to-br from-slate-50 to-emerald-50 dark:from-slate-950 dark:to-slate-900",
    );
    ...
    content = content.replace(
      /bg-red-50(\/50)?/g,
      "bg-red-50$1 dark:bg-red-950/20",
    );
    ...
    content = content.replace(
      /from-white to-white/g,
      "from-white to-white dark:from-slate-900 dark:to-slate-900",
    );
    content = content.replace(
      /from-slate-50/g,
    ...
    content = content.replace(
      /via-slate-200/g,
      "via-slate-200 dark:via-slate-800",
    );
    ...
    content = content.replace(
      /border-pink-100/g,
      "border-pink-100 dark:border-pink-900/50",
    );
    content = content.replace(
    ...
    // Pool colors
    content = content.replace(
      /from-amber-50 to-yellow-50/g,
      "from-amber-50 to-yellow-50 dark:from-amber-950/30 dark:to-yellow-950/30",
    );
    content = content.replace(
      /from-blue-50 to-indigo-50/g,
      "from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30",
    );
    content = content.replace(
      /from-emerald-50 to-teal-50/g,
      "from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30",
    );
    content = content.replace(
      /from-rose-50 to-red-50/g,
