-- Drop all overloads of accept_friendly_match to resolve ambiguity
...
BEGIN
  ...
  IF agreed >= required THEN
    ...
    -- We pass confirmer_id because confirm_friendly_match expects a UUID. 
    -- The checks inside confirm_friendly_match will safely pass because we already
    -- verified the confirmer is an opponent and not the submitter.
