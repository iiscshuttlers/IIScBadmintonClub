-- Fix submit_tournament_match and recalculate_tournament_elo by removing non-existent columns (wins, losses)
...
-- Update recalculate_tournament_elo removing non-existent columns (wins, losses)
