-- Drop all overloads of confirm_friendly_match to eliminate function signature ambiguity
DROP FUNCTION IF EXISTS public.confirm_friendly_match(UUID, UUID);
DROP FUNCTION IF EXISTS public.confirm_friendly_match(TEXT, UUID);
DROP FUNCTION IF EXISTS public.confirm_friendly_match(TEXT, TEXT);
DROP FUNCTION IF EXISTS public.confirm_friendly_match(UUID, TEXT);
