    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center bg-slate-100 p-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-sm text-center space-y-6">
          ...
          <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-200 text-slate-700 font-bold py-3 rounded-xl hover:bg-slate-50 transition-colors">
          ...
          <div className="space-y-3">
            <div className="flex flex-wrap gap-2">
              {data.formats.map((f: string) => (
                <button key={f} onClick={() => { setSelectedFormat(f); setSelectedMatchId(''); }}
          ...
          {selectedMatchId && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6">
              ...
              <div className="flex items-center gap-2 overflow-x-auto pb-2">
                ...
                {scores.length < 5 && (
                  <button onClick={addNewSet} className="p-2 rounded-full bg-slate-100 text-emerald-600 hover:bg-emerald-50 ml-auto">
                    <PlusCircle size={20} />
                  </button>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <button onClick={() => updateScore('p1', -1)} className="w-full py-3 bg-slate-100 rounded-xl text-slate-500 font-bold flex justify-center active:bg-slate-300">
                    <Minus size={20} />
                  </button>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <button onClick={() => updateScore('p2', -1)} className="w-full py-3 bg-slate-100 rounded-xl text-slate-500 font-bold flex justify-center active:bg-slate-300">
                    <Minus size={20} />
                  </button>
                </div>
              </div>
