...
- Name: umpire-engine.spec.ts >> Umpire Engine: Chaos Resilience >> Race Condition: Concurrent Rapid Taps are dropped while syncing
- Location: tests\umpire-engine.spec.ts:44:3
...
Locator: locator('[data-testid="btn-add-point-t1"]').first()
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 30000ms
  - waiting for locator('[data-testid="btn-add-point-t1"]').first()
