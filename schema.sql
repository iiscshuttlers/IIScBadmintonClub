...
CREATE TABLE IF NOT EXISTS "public"."players" (
    ...
    "singles_record" "text" DEFAULT '0W - 0L'::"text",
    "doubles_record" "text" DEFAULT '0W - 0L'::"text",
    "mixed_record" "text" DEFAULT '0W - 0L'::"text"
);
...
CREATE OR REPLACE FUNCTION "public"."enqueue_tournament_match_notifications"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  recipients UUID[];
...
ALTER FUNCTION "public"."enqueue_tournament_match_notifications"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."recalculate_all_win_loss_records"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  rec RECORD;
...
ALTER FUNCTION "public"."recalculate_all_win_loss_records"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."recalculate_player_win_loss_records"("p_player_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  WITH match_participants AS (
...
ALTER FUNCTION "public"."recalculate_player_win_loss_records"("p_player_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."trigger_update_win_loss_records"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE 
  rec RECORD;
...
ALTER FUNCTION "public"."trigger_update_win_loss_records"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."undo_tournament_match"("p_match_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_match tournament_matches%ROWTYPE;
...
ALTER FUNCTION "public"."undo_tournament_match"("p_match_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tournament_matches" (
    ...
    CONSTRAINT "tournament_matches_winner_side_check" CHECK (("winner_side" = ANY (ARRAY[0, 1, 2])))
);
...
CREATE OR REPLACE TRIGGER "trg_enqueue_match_notifications" AFTER UPDATE OF "status" ON "public"."tournament_matches" FOR EACH ROW EXECUTE FUNCTION "public"."enqueue_tournament_match_notifications"();
...
CREATE OR REPLACE TRIGGER "trg_update_win_loss_friendly" AFTER INSERT OR DELETE OR UPDATE ON "public"."matches" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_update_win_loss_records"();



CREATE OR REPLACE TRIGGER "trg_update_win_loss_tournament" AFTER INSERT OR DELETE OR UPDATE ON "public"."tournament_matches" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_update_win_loss_records"();
...
CREATE POLICY "Admins can view all queued notifications" ON "public"."notification_queue" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."players"
  WHERE (("players"."id" = "auth"."uid"()) AND ("players"."role" = ANY (ARRAY['admin'::"text", 'master_admin'::"text"]))))));
...
GRANT ALL ON FUNCTION "public"."enqueue_tournament_match_notifications"() TO "anon";
GRANT ALL ON FUNCTION "public"."enqueue_tournament_match_notifications"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enqueue_tournament_match_notifications"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."recalculate_all_win_loss_records"() TO "anon";
GRANT ALL ON FUNCTION "public"."recalculate_all_win_loss_records"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."recalculate_all_win_loss_records"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."recalculate_player_win_loss_records"("p_player_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."recalculate_player_win_loss_records"("p_player_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."recalculate_player_win_loss_records"("p_player_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."trigger_update_win_loss_records"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_update_win_loss_records"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_update_win_loss_records"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."undo_tournament_match"("p_match_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."undo_tournament_match"("p_match_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."undo_tournament_match"("p_match_id" "uuid") TO "service_role";
