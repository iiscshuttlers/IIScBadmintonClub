...
CREATE TABLE IF NOT EXISTS "public"."players" (
    ...
    "pref_receive_push" boolean NOT NULL DEFAULT true,
    "pref_receive_email" boolean NOT NULL DEFAULT true,
    "pref_notify_smash" boolean NOT NULL DEFAULT true,
    "pref_notify_point" boolean NOT NULL DEFAULT true,
    "pref_notify_serve" boolean NOT NULL DEFAULT true,
    "pref_notify_whistle" boolean NOT NULL DEFAULT true,
    "pref_notify_victory" boolean NOT NULL DEFAULT true,
