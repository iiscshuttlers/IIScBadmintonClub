-- ============================================================
-- Migration: Add favorite_format and update ELO calculation
-- ============================================================

ALTER TABLE players ADD COLUMN IF NOT EXISTS favorite_format TEXT;

-- Update the confirm_friendly_match RPC to include gender-based Elo multipliers for both Singles and Doubles
-- and properly calculate Elo changes for all 4 players in a Doubles match.

ALTER TABLE matches ADD COLUMN IF NOT EXISTS elo_change_p3 INTEGER;
ALTER TABLE matches ADD COLUMN IF NOT EXISTS elo_change_p4 INTEGER;
