                ...
                {activeTab === "basic" && (
                  ...
                  >
                    ...
                    <div className="pt-6 border-t border-slate-200 dark:border-slate-700/50 mt-6 space-y-3">
                      <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                        <Lock className="w-4 h-4 text-emerald-500" /> Account
                        Security
                      </h3>
                      ...
                      <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                        Setting a password allows you to log in with your email
                        and password instead of using OTP codes.
                      </p>
                    </div>
                  </motion.div>
                )}
                            ...
                            <div className="flex justify-between items-center pr-12">
                              ...
                              {rackets.length > 1 && (
                                <button
                                  ...
                                  onClick={() => {
                                    setRackets(
                                      rackets.filter((_, idx) => idx !== index),
                                    );
                                    if (primaryRacketIndex === index)
                                      setPrimaryRacketIndex(0);
                                    else if (primaryRacketIndex > index)
                                      setPrimaryRacketIndex(
                                        primaryRacketIndex - 1,
                                      );
                                  }}
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (
                                tourName.trim() &&
                                tourYear.trim() &&
                                /^\d{4}$/.test(tourYear.trim())
                              ) {
                                const val = `${tourName.trim()} ${tourYear.trim()}`;
                                setTournamentsRaw(
                                  tournamentsRaw.trim()
                                    ? tournamentsRaw.trim() + ", " + val
                                    : val,
                                );
                                setTourName("");
                                setTourYear("");
                        ...
                        <div className="flex flex-wrap gap-2 w-full items-center">
                          ...
                          {achMedal === "Other" && (
                            <input
                              ...
                              onChange={(e) =>
                                setAchCustomMedal(e.target.value)
                              }
                      ...
                      {careerHighlights.length === 0 ? (
                        <div className="text-center p-6 bg-slate-50 dark:bg-slate-800/50 border border-dashed border-slate-300 dark:border-slate-700 rounded-2xl">
                          <p className="text-slate-500 dark:text-slate-400 text-sm">
                            Add custom narrative milestones (e.g. "Joined IISc
                            Team") to show on your profile timeline.
                          </p>
                        </div>
                      ) : (
                        <div className="space-y-4">
                            ...
                            <div className="flex-1 space-y-3">
                              <div>
                                ...
                                <input
                                  ...
                                  onBlur={(e) =>
                                    handleImageBlur(idx, e.target.value)
                                  }
                    ...
                    <div className="space-y-4 pt-6 border-t border-slate-100 dark:border-slate-800">
                      ...
                      <div className="space-y-3">
                            ...
                            <div className="flex-1 space-y-3">
                              <div>
                                ...
                                <input
                                  ...
                                  onBlur={(e) =>
                                    handleVideoBlur(idx, e.target.value)
                                  }
                                  className={`w-full px-3 py-2 rounded-xl border bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-xs outline-none focus:ring-2 focus:ring-emerald-500
                                ...
                                {vid.url &&
                                  videoPreviewIds.length > idx &&
                                  videoPreviewIds[idx] === null && (
                                    <p className="mt-1 text-[11px] text-rose-500 font-semibold">
                        ...
                        {mediaVideos.length === 0 && (
                          <div className="text-center py-6 border border-dashed border-slate-200 dark:border-slate-800 rounded-2xl text-slate-400 text-sm">
                            No match videos added yet. Link your YouTube
                            highlights!
                          </div>
                        )}
                      </div>
