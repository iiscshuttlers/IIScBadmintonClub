        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-10 shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400 mt-1">Effective Date: June 15, 2026 · Last Updated: June 16, 2026</p>
            </div>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-600 dark:text-slate-300">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">5. Data Security</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">6. Local Storage & Cookies</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">7. Push Notifications</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">8. Children's Privacy</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">9. Your Rights</h3>
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">10. Data Retention</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">11. International Data Transfers</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">12. Changes to This Policy</h3>
            <p>
