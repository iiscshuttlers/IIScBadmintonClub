...
import { ArrowRight, Bell, CalendarDays, Medal, Trophy, Users, ChevronRight, Star, ExternalLink } from 'lucide-react';
...
export default function Home() {
  ...
  useEffect(() => {
    fetchSiteData("site_config", "site_config.json").then(data => {
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden text-white min-h-[88vh] flex items-center">
        ...
        <div className="container mx-auto px-4 py-20 lg:py-24 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <motion.div variants={fadeUp} initial="hidden" animate="visible" className="hidden lg:flex relative justify-center items-center">
              <AnimatedLogo />
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 relative overflow-hidden bg-white dark:bg-slate-950">
        <div className="container mx-auto px-4 relative z-10 max-w-6xl">
          ...
          >
            ...
            <h2 className="text-5xl lg:text-6xl font-black text-blue-900 dark:text-white mb-6 leading-tight" style={{ fontFamily: 'Playfair Display, serif' }}>
              About IISc
              <br />
          ...
          >
            ...
            <motion.div variants={fadeUp} className="space-y-5">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-3xl font-black text-blue-900 dark:text-white" style={{ fontFamily: 'Playfair Display, serif' }}>
                  Our Mission
                </h3>
              </div>
              <p className="text-gray-600 dark:text-slate-300 text-lg leading-relaxed whitespace-pre-wrap">
                {config?.about?.mission || "To foster excellence in badminton through competitive play and community engagement at IISc. We aim to develop skilled players while promoting discipline, teamwork, and sportsmanship."}
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                {VALUES.map((v) => (
                  ...
                  >
                    ...
                    <h4 className="font-black text-blue-900 dark:text-white text-sm mb-1">{v.title}</h4>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 border-t border-slate-200 dark:border-slate-800">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { icon: '👥', label: 'Members', value: config?.stats?.members || '350+', desc: 'Active players across all skill levels', color: 'from-emerald-500 to-teal-600' },
              { icon: '🏆', label: 'Tournaments', value: config?.stats?.tournaments || '20+', desc: 'Organized competitive events since inception', color: 'from-amber-500 to-orange-500' },
              { icon: '🏅', label: 'IISM Trophies', value: config?.stats?.trophies || '10+', desc: 'Medals brought home from the national stage', color: 'from-blue-600 to-indigo-600' },
            ].map((item) => (
              <motion.div
                key={item.label}
                variants={fadeUp}
