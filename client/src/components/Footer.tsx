    ...
    <footer className="bg-blue-900 text-white mt-16">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* About */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-emerald-400">IISc Badminton Club</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/">
                  <span className="text-gray-300 hover:text-emerald-400 transition-colors cursor-pointer">Home</span>
                </Link>
              </li>
              <li>
                <Link href="/about">
                  <span className="text-gray-300 hover:text-emerald-400 transition-colors cursor-pointer">About</span>
                </Link>
              </li>
              <li>
                <Link href="/events">
                  <span className="text-gray-300 hover:text-emerald-400 transition-colors cursor-pointer">Events</span>
                </Link>
              </li>
              <li>
                <Link href="/gallery">
                  <span className="text-gray-300 hover:text-emerald-400 transition-colors cursor-pointer">Gallery</span>
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex gap-2 items-center">
                ...
                <a href="mailto:badminton@iisc.ac.in" className="text-gray-300 hover:text-emerald-400 transition-colors">
                  badminton@iisc.ac.in
                </a>
              </div>
              <div className="flex gap-2 items-center">
                <Phone className="w-5 h-5 text-emerald-400 flex-shrink-0" />
                <span className="text-gray-300">+91 (080) 2293 2000</span>
              </div>
            </div>
          </div>
