        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4 lg:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              ...
              training, and community engagement at the Indian Institute of
              Science.
            </p>
            <div className="flex gap-3 pt-1">
              ...
              >
                <svg
                  ...
                  className="w-4 h-4 text-slate-400 hover:text-pink-400"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-sm text-emerald-400 uppercase tracking-widest mb-5">
              Quick Links
            </h4>
            ...
            <div className="space-y-4 text-sm">
              <div className="flex gap-3 items-start">
                ...
                <span className="text-slate-400 leading-relaxed">
                  IISc Gymkhana, Bangalore — 560012, India
                </span>
              </div>
          ...
          <div>
            ...
            <h4 className="font-bold text-sm text-emerald-400 uppercase tracking-widest mb-3">
              Facilities
            </h4>
            <ul className="space-y-2 text-sm text-slate-400">
              <li className="flex items-center gap-2">
                <span className="text-emerald-500">✓</span> 3 Indoor Courts
              </li>
              <li className="flex items-center gap-2">
                <span className="text-emerald-500">✓</span> Synthetic Mat
                Flooring
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                <span className="text-emerald-500">✓</span> Tournament Hosting
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-600 text-xs">
              © {new Date().getFullYear()} IISc Badminton Club. All rights
              reserved.
