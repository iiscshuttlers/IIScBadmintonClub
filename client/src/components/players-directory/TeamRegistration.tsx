          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-5 border border-slate-200 dark:border-slate-700">
            ...
            <div className="mt-6 flex justify-center">
              <button
                ...
                className="flex items-center gap-2 bg-violet-600 hover:bg-violet-700 disabled:opacity-50 disabled:cursor-not-allowed text-on-accent px-6 py-3 rounded-xl font-black text-sm uppercase tracking-wider transition-colors shadow-lg shadow-violet-500/20"
              >
