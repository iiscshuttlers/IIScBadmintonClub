      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-sm font-black transition-all bg-violet-600 hover:bg-violet-700 text-white shadow-lg shadow-violet-500/20"
          >
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-12 text-center border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <h3 className="text-lg font-black text-slate-900 dark:text-white mb-2">No Teams Found</h3>
            <p className="text-slate-500">There are no registered {category === "doubles" ? "Doubles" : "Mixed Doubles"} teams yet. Be the first to register a team!</p>
          </div>
        ) : (
