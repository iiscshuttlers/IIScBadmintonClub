      ...
      <div className="flex justify-center mb-12">
        <div className="bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl flex gap-1 shadow-inner border border-slate-200 dark:border-slate-700">
          ...
          <div
            ...
            role="button"
            className={`px-6 py-2.5 rounded-xl text-sm font-black transition-all flex items-center gap-1.5 cursor-pointer ${activeTab === "ironman" ? "bg-gradient-to-r from-orange-500 to-rose-500 text-on-accent shadow-md" : "text-muted-foreground hover:text-muted-foreground dark:hover:text-slate-300"}`}
          >
        ...
        {activeTab === "elo" && (
          <div className="flex gap-1 bg-slate-100/50 dark:bg-slate-800/30 p-1.5 rounded-2xl border border-slate-200/50 dark:border-slate-700/50 shrink-0">
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition-all flex items-center gap-1.5 ${eloMode === "tournament" ? "bg-amber-500 text-on-accent shadow-sm" : "text-muted-foreground hover:text-muted-foreground dark:hover:text-slate-300"}`}
            >
