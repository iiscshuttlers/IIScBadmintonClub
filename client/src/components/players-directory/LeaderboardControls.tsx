    ...
    <>
      <div className="flex justify-center mb-12">
        <div className="bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl flex gap-1 shadow-inner border border-slate-200 dark:border-slate-700">
          <div
            ...
            role="button"
            className={`px-6 py-2.5 rounded-xl text-sm font-black transition-all flex items-center gap-1.5 cursor-pointer ${activeTab === "elo" ? "bg-white dark:bg-slate-900 text-primary shadow-sm" : "text-muted-foreground hover:text-muted-foreground dark:hover:text-slate-300"}`}
          >
          ...
          <div
            ...
            role="button"
            className={`px-6 py-2.5 rounded-xl text-sm font-black transition-all flex items-center gap-1.5 cursor-pointer ${activeTab === "ironman" ? "bg-gradient-to-r from-orange-500 to-rose-500 text-foreground shadow-md" : "text-muted-foreground hover:text-muted-foreground dark:hover:text-slate-300"}`}
          >
            ...
            <InfoModal
              ...
              triggerClassName={activeTab === "ironman" ? "text-orange-100 hover:text-foreground" : ""}
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-10 px-4">
        ...
        {activeTab === "elo" && (
          <div className="flex gap-1 bg-slate-100/50 dark:bg-slate-800/30 p-1.5 rounded-2xl border border-slate-200/50 dark:border-slate-700/50 shrink-0">
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition-all flex items-center gap-1.5 ${eloMode === "tournament" ? "bg-amber-500 text-foreground shadow-sm" : "text-muted-foreground hover:text-muted-foreground dark:hover:text-slate-300"}`}
            >
        ...
        <button
           ...
           className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-muted-foreground dark:text-slate-300 font-bold text-xs transition-all border border-slate-200 dark:border-slate-700 w-full md:w-auto justify-center md:absolute right-4"
        >
