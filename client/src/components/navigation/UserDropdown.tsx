      ...
      <DropdownMenuTrigger asChild>
        <button className="relative w-8 h-8 rounded-full border-2 border-slate-200 dark:border-slate-700 hover:border-primary transition-all duration-200 overflow-hidden shrink-0 shadow-sm cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-slate-950">
          {userAvatar ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-primary to-teal-600 text-foreground flex items-center justify-center font-black text-xs">
              {userName ? userName[0].toUpperCase() : "U"}
            </div>
          )}
          {pendingActionCount > 0 && (
            <span className="absolute -top-1 -right-1 flex h-3 w-3 items-center justify-center rounded-full bg-rose-500 text-[8px] font-bold text-foreground shadow ring-1 ring-white dark:ring-slate-950">
