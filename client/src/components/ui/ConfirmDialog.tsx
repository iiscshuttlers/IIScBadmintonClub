  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <h2 id="confirm-dialog-title" className="text-base font-black text-foreground dark:text-foreground mb-2">
            {title}
          </h2>
          <p className="text-sm text-muted-foreground dark:text-muted-foreground mb-6">{description}</p>
