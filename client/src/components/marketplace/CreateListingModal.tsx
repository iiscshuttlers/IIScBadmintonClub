      ...
      <DialogContent className="sm:max-w-md bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 max-h-[90vh] overflow-y-auto w-[95vw] sm:w-full rounded-2xl">
        ...
        <div className="mt-4 flex p-1 bg-slate-100 dark:bg-slate-800 rounded-xl">
          <button
            ...
            className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${listingType === 'sell' ? 'bg-white dark:bg-slate-700 text-primary dark:text-primary shadow-sm' : 'text-muted-foreground hover:text-muted-foreground dark:hover:text-slate-300'}`}
          >
            Selling an Item
          </button>
          <button
            ...
            className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${listingType === 'buy' ? 'bg-white dark:bg-slate-700 text-indigo-600 dark:text-indigo-400 shadow-sm' : 'text-muted-foreground hover:text-muted-foreground dark:hover:text-slate-300'}`}
          >
            Looking to Buy
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-2">
          <div>
            <label className="text-xs font-bold text-muted-foreground dark:text-muted-foreground uppercase tracking-widest block mb-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-xs font-bold text-muted-foreground dark:text-muted-foreground uppercase tracking-widest block">
          ...
          <div>
            <label className="text-xs font-bold text-muted-foreground dark:text-muted-foreground uppercase tracking-widest block mb-2">Category</label>
          ...
          <div>
            <label className="text-xs font-bold text-muted-foreground dark:text-muted-foreground uppercase tracking-widest block mb-2">Description</label>
            <textarea 
          ...
          <div>
            <label className="text-xs font-bold text-muted-foreground dark:text-muted-foreground uppercase tracking-widest block mb-2">Image URL (Optional)</label>
            <div className="relative">
