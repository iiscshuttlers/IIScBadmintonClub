  ...
  return (
    <DropdownMenu open={open} onOpenChange={(o) => { setOpen(o); if (o) markAllAsRead(); }}>
      <DropdownMenuTrigger asChild>
        <button className="relative p-2 rounded-xl text-muted-foreground dark:text-muted-foreground hover:text-on-accent dark:hover:text-on-accent hover:bg-slate-100 dark:hover:bg-slate-800 transition-all mr-1">
