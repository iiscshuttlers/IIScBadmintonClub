...
export function PwaInstallPrompt() {
  const { isInstallable, isDismissed, triggerInstall, dismissInstall } = useInstallPrompt();
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {isIOS ? (
                ...
                <p className="text-xs text-blue-100">Install for a faster, app-like experience.</p>
              )}
            </div>
          </div>
