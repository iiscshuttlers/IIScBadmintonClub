...
export function TournamentSection() {
  ...
  const infoCards = [
    {
      icon: Calendar,
      label: "Dates",
      value: tournamentDatesDisplay(config),
  ...
  // Registration CTA presentation based on form status.
  const status = config.formStatus;
  const hasForm = !!config.formUrl && status !== "disabled";
