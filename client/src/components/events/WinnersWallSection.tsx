        ...
        <div className="flex justify-center max-w-6xl mx-auto">
          <div className="bg-white dark:bg-slate-900 p-1.5 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 flex gap-1">
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-xl font-bold text-sm transition-all ${filter === "open" ? "bg-primary text-foreground shadow-md" : "text-muted-foreground dark:text-muted-foreground hover:bg-slate-100 dark:hover:bg-slate-800"}`}
            >
              Open Tournaments
            </button>
            <button
