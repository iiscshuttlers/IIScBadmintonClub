    ...
    <div className="space-y-6">
      ...
      <div className={cardCls}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-black text-slate-800 dark:text-white">Tournament Section</h3>
        </div>
      ...
      {/* Dates */}
      <div className={cardCls}>
        <h3 className="font-black text-slate-800 dark:text-white mb-1">Dates</h3>
        ...
        <p className="text-xs text-slate-400 mt-3">
          Preview: <span className="font-bold text-slate-600 dark:text-slate-300">{tournamentDatesDisplay(config)}</span>
        </p>
      </div>
      ...
      <div className="flex justify-end">
        <button
          ...
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold transition shadow-lg shadow-emerald-500/20"
        >
