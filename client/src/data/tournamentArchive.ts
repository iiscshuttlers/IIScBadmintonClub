...
export const ARCHIVED_TOURNAMENTS: ArchivedTournament[] = [
  ...
  },
  {
    ...
    winners: [
      ...
      {
        category: "Cat 1: Women's Singles",
        winner: "Tanisha",
        runnerUp: "Renu",
      },
      {
        category: "Cat 1: Men's Doubles",
        winner: "Gokul & Piyush",
        runnerUp: "Arun & Varun",
      },
      {
        category: "Cat 1: Women's Doubles",
        winner: "Tanisha & Renu",
        runnerUp: "Radhika & Madhuvanti",
      },
      {
        category: "Cat 1: Mixed Doubles",
        winner: "Kaling & Aditi",
        runnerUp: "Atul & Ritul",
      },
      {
        category: "Cat 2: Men's Singles",
        winner: "Arindhan",
        runnerUp: "Krishnendu",
      },
      {
        category: "Cat 2: Women's Singles",
        winner: "Shaili",
        runnerUp: "Dimple",
      },
      {
        category: "Cat 2: Men's Doubles",
        winner: "Arindhan & Krishnendu",
        runnerUp: "Dilshad & Gowtham",
      },
      {
        category: "Cat 2: Women's Doubles",
        winner: "Dimple & Rakshita",
        runnerUp: "Sneha & Aparna",
      },
      {
        category: "Cat 2: Mixed Doubles",
        winner: "Shaili & Dilshad",
        runnerUp: "Abhishek & Sonali",
      },
    ],
  },
  {
  ...
  const processNames = (
    ...
    for (const name of names) {
      ...
      if (existing) {
        ...
        if (!existing.tournaments.includes(tName))
          existing.tournaments.push(tName);
